...
<div align="right">
    {{ link_to("radacct/new", "Create radacct") }}
</div>

{{ form("radacct/search", "method":"post", "autocomplete" : "off") }}

<div align="center">
    <h1>Search radacct</h1>
</div>

<table>
    <tr>
        <td align="right">
            <label for="radacctid">Radacctid</label>
        </td>
        <td align="left">
            {{ text_field("radacctid", "type" : "numeric") }}
        </td>
    </tr>
    <tr>
        <td align="right">
